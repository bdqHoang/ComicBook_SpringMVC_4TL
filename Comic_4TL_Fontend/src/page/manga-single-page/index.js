  ...
  return (
    <>
      ...
      <div id="preloader-active">
        <div
          class="preloader d-flex align-items-center
          ...
          <div class="main-header ">
            <div class="header-top d-none d-md-block">
              <div class="container">
                <div class="col-xl-12">
                  <div
                    class="header-info-right d-flex
                                    justify-content-end"
                  >
            ...
            <div class="header-bottom header-sticky">
              <div class="container">
                <div class="row align-items-center">
                  <div
                    class="col-xl-10 col-lg-8 col-md-12
                                    header-flex"
                  >
                    ...
                    <div class="main-menu d-none d-md-block">
                      <nav>
                        <ul id="navigation">
                          ...
                          <li>
                            <a href="manga_all.html">Latest Manga</a>
                          </li>
                          <li>
                            <a href="blog.html">Blog</a>
                          </li>
                          <li>
                            <a class="js-show-modal1" href="#">
                              <i
                                class="fa-regular
                                                            fa-user"
                              ></i>
                  ...
                  <div
                    class="col-lg-3 col-xl-2 col-md-12 d-flex
                                    justify-content-center"
                  >
                    <ul
                ...
                <div
                  class="modal-search-header flex-c-m trans-04
                ...
                >
                  <div class="container-search-header">
                    ...
                    <form
                      class="wrap-search-header flex-w
                                        p-l-15"
                    >
        ...
        <div class="footer-main">
          <div class="container">
            ...
            <div class="row justify-content-between mt-5">
              ...
              <div
                class="col-lg-4 col-md-6 footer-widget mt-5
                            mt-md-0"
              >
              ...
              <div class="col-md-6 col-6">
                <div class="copyright-info">
                  <span>
                    ...
                    Designed by{" "}
                    <a href="https://www.templatemonster.com/authors/soulknight404/">
                      SoulKnight404
                    </a>
                  </span>
                </div>
              ...
              <div class="col-md-6 col-6">
                <div class="footer-menu text-end text-md-right">
                  <ul class="list-unstyled">
                    ...
                    <li>
                      <a href="news-left-sidebar.html">Privacy Policy</a>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <div class="wrap-modal1 js-modal1 p-t-60 p-b-20">
        <div
          class="overlay-modal1 js-hide-modal1" style="background:url(https://yae.hifive03.com/assets/img/manga_banner/log.jpg) fixed no-repeat center/cover ;"></div>
        <div class="container">
