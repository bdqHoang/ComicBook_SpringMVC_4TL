            ...
            <div className="col-lg-12">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">The Boy in the All-Girls School </li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div className="container">
        ...
        <div className="row">
            <div className="col-lg-3">
                <img className="w-100 img-fluid" src="https://yae.hifive03.com/assets/img/manga_single/single1.jpg"
                    alt="" />
            </div>
            <div className="col-lg-6">
                ...
                <div className="manga_info">
                    <ul>
                        ...
                        <li className="d-flex flex-wrap">
                            <h6>Alternative </h6>
                            <p>女子学院的男生 ; Boy in A Girls' School ; Nuzi
                                Xueyuan de Nansheng</p>
                        </li>
                        <li className="d-flex flex-wrap">
                            <h6>Genre(s) </h6>
                            <p>
                        ...
                        <li className="d-flex flex-wrap watch">
                            <a className="mr-2" href="chapter/chapter.html">Read First</a><a
                                href="chapter/chapter06.html">Read
                                Last</a>
                        </li>
                    </ul>
                </div>
        ...
        <div className="row">
            <div className="col-lg-8">
                ...
                <div className="manga_info">
                    <p>In an all-girls school full of jaw-dropping
                        beauties, a male student suddenly transfers
                        in!!!
                        Perhaps in the eyes of others, this would be a
                        dream-like paradise, but in reality, the
                        future is completely unimaginable <span id="dots">...</span><span id="more">erisque
                            enim
                            ligula venenatis dolor. Maecenas nisl est,
                            ultrices nec
                            congue eget, auctor vitae massa. Fusce
                            luctus vestibulum augue ut aliquet. Nunc
                    ...
                    <button onclick="if (!window.__cfRLUnblockHandlers)
                                return false; myFunction()" id="read_more"
                        data-cf-modified-6c234f31212b61c935b6d039-="">Read
                        more</button>
                    ...
                    <ul className="chapter mb-3">
                        <li>
                            <a href="chapter/chapter.html" className="d-flex flex-wrap
                                ...
                                <span>Chapter 00</span><span>07/19/2020
                                </span>
                            </a>
                        </li>
                        <li>
                            <a href="chapter/chapter01.html" className="d-flex flex-wrap
                                        justify-content-between">
                                <span>Chapter 1 - The Beginning of
                                    Everything </span><span>07/19/2020
                                </span>
                            </a>
                        </li>
                        <li>
                            <a href="chapter/chapter02.html" className="d-flex flex-wrap
                                        justify-content-between">
                                <span>Chapter 2 - Friends and Relatives
                                </span><span>07/19/2020 </span>
                            </a>
                        </li>
                        <li>
                            <a href="chapter/chapter03.html" className="d-flex flex-wrap
                                        justify-content-between">
                                <span>Chapter 3 - First Visit to the
                                    All-Girls School </span><span>07/19/2020
                                </span>
                            </a>
                        </li>
                        <li>
                            <a href="chapter/chapter04.html" className="d-flex flex-wrap
                                        justify-content-between">
                                <span>Chapter 4 - A Surprise While Out
                                    Strolling </span><span>07/19/2020
                                </span>
                            </a>
                        </li>
                        <li>
                            <a href="chapter/chapter05.html" className="d-flex flex-wrap
                                        justify-content-between">
                                <span>Chapter 5 - Appropriate
                                    Countermeasures </span><span>07/19/2020
                                </span>
                            </a>
                        </li>
                        <li>
                            <a href="chapter/chapter06.html" className="d-flex flex-wrap
                                        justify-content-between">
                                <span>Chapter 6 - First Day of School
                                </span><span>07/19/2020 </span>
                            </a>
                        </li>
                    </ul>
            ...
            <div className="col-lg-4">
                ...
                <a href="#">
                    <div className="trand-right-single d-flex">
                        <div className="trand-right-img">
                            <img className="play" src="assets/img/manga/small9.jpg" alt="" />
                            <div className="overlay_play2">
                ...
                <a href="#">
                    <div className="trand-right-single d-flex">
                        <div className="trand-right-img">
                            <img className="play" src="assets/img/manga/small10.jpg" alt="" />
                            <div className="overlay_play2">
                                <i className="fa-solid fa-heart"> 99M</i>
                            </div>
                        </div>
                        <div className="trand-right-cap">
                            <h4>Gedou Tenisha no Harem Dungeon Seisakuki
                            </h4>
                            <ul className="d-flex flex-wrap star">
                                <li><i className="fa-solid fa-star"></i></li>
                                <li><i className="fa-solid fa-star"></i></li>
                ...
                <a href="#">
                    <div className="trand-right-single d-flex">
                        <div className="trand-right-img">
                            <img className="play" src="assets/img/manga/small11.jpg" alt="" />
                            <div className="overlay_play2">
                                <i className="fa-solid fa-heart"> 61M</i>
                            </div>
                        </div>
