...
import com.comic_4tl.backend_comic_4tl.repository.EmailRespository;

import jakarta.mail.MessagingException;
import jakarta.mail.internet.MimeMessage;

@Service
public class EmailServices implements EmailRespository {
    ...
    // send mail with attachment(file, img ???/)
    @Override
